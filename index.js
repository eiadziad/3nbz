    ...
    if (isModerator || isBroadcaster) {
      if (message.toLowerCase() === '!راح') {
        if (!isTiming) {
          ...
          firstMessageSent = ` ترك البث في الساعة : ${currentTime}`;
      ...
      if (message.toLowerCase() === '!رجع') {
        if (isTiming) {
          ...
          client.say(channel, ` HAS BEEN AFK  ${uptimeString}`);
